...
**Status: DRAFT — foundational decisions RESOLVED (Kelvin 2026-05-20); libraries selected (vsss-rs + crypto_box); AWAITING the external-auditor pre-opinion on the construction BEFORE build (Kelvin chose option b). The cryptographic heart of Option-2 social recovery + the single most external-audit-critical piece in the project (§16.3, D-011). Conservative posture; uncertainty flagged, not papered over.**
